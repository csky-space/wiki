...
-  Вкладка **Receiver**-> Receiver Mode: **Serial**->Seriak Receiver Provider: **CRSF**
   ...
   ![](./podklyuchenie-poletnogo-kontrollera-po-crsf-17.png){width=1568px height=1354px}

   :::

   :::info:true Raspberry Pi 5

   ![](./podklyuchenie-poletnogo-kontrollera-po-crsf-18.png){width=1568px height=1354px}
