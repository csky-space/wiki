...
-  Вкладка **Receiver**-> Receiver Mode: **Serial**->Seriak Receiver Provider: **CRSF**
   ...
   ![](./podklyuchenie-poletnogo-kontrollera-po-crsf-11.png){width=1568px height=1354px}

   :::

   :::info:true Raspberry Pi 5

   ![](./podklyuchenie-poletnogo-kontrollera-po-crsf-13.png){width=1568px height=1354px}
