...
-  Интерфейс настройки Astra(не запускался в редких случаях)
...
-  Добавлен инструмент прошивки EEPROM адаптеров с чипом Macrosilicon MS2107(возможно и для MS2106/MS2109/MS2130, но осторожно, не тестировалось!)
...
-  Небольшие исправления хранения настроек
